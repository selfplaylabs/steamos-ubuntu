# SteamOS Ubuntu
> fixed version (original deprecated project by [ShadowApex](https://github.com/ShadowApex/steamos-ubuntu))
...
`git clone https://github.com/selfplaylabs/steamos-ubuntu.git`
